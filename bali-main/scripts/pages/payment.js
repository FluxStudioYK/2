document.addEventListener('DOMContentLoaded', function() {
    ...
    // Function to pre-fill user data if logged in
    async function prefillUserData() {
        try {
            ...
            if (user) {
                // Get user profile data including all details
            ...
            // Continue without pre-filling if user is not logged in
        }
    }
    ...
    if (paymentForm) {
        paymentForm.addEventListener('submit', async function(e) {
            ...
            const orderDetails = {
                ...
                user_id: userId // Add user_id to link order with user profile
            };
